...
<head>
    ...
    <title>Statistique hebdomadaire-admin</title>
...
<body>
        ...
        <div class="container"><br>
            <div class="container my-3 main-nav--bg stat-cards-item"><br>
                <h3 class="main-title">Statistique Hebdomadaire :</h3>
                <form action="/stathebdo-admin" method="POST">
                    @csrf
            ...
            <div>
                @if (isset($nb_ticket))
                <h5 class="my-3 main-title">Statistique de {{$nom_inter}} du Semaine de {{$weekNumber}} ({{$startOfMonth}} à {{$endOfMonth}}) :</h5>
