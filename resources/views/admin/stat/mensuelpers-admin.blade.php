...
<head>
    ...
    <title>Statistique Mensuel-admin</title>
       ...
       @endif
        <div class="container">
            <div class="container my-3 main-nav--bg stat-cards-item"><br>
                ...
                <form action="/statmensuel-admin" method="POST">
                    @csrf
            ...
            <div>
                ...
                <h5 class="my-3 main-title">Statistique de {{$nom_inter}} Pour le Mois de ({{$startOfMonth}})</h5>
                  ...
                  <div class="col-md-6 col-xl-3">
                    <article class="stat-cards-item">
                      ...
                      <div class="stat-cards-info">
                        ...
                        <p class="stat-cards-info__title">Délai Total : </p>
                        <p class="stat-cards-info__progress">
                          <span class="stat-cards-info__profit danger">
