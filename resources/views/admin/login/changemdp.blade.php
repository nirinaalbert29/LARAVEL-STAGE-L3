    ...
    @endif
        ...
        @section("contenu")
            ...
            <div class="container-fluide">
                <form class="sign-up-form form" action="/changemdp-admin/{{$admin->id}}" method="POST">
                    @csrf
                    @method('put')
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="password" class="form-control form-input" placeholder="Saisir mot de passe" name="mdp_admin1" required>
                            <div class="input-group-append">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="password" class="form-control form-input" placeholder="Saisir mot de passe" name="mdp_a" required>
                            <div class="input-group-append">
            ...
            <script>
                $(document).ready(function() {
                    ...
                    $('.sign-up-form').submit(function(event) {
                        ...
                        var mdpAdmin1 = $('input[name="mdp_admin1"]').val();
                        var mdpA = $('input[name="mdp_a"]').val();

                        // Comparer avec la valeur de $admin->mdp_admin
                        if (mdpActuel !== "{{ $admin->mdp_admin }}") {
            ...
            <script>
                ...
                var passwordInput = document.querySelector('input[name="mdp_admin1"]');
                ...
                var passwordInput3 = document.querySelector('input[name="mdp_a"]');
