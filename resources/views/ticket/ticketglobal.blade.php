        ...
        @endif
            ...
            <div class="container-fluid mt-3">
                <div class="d-flex justify-content-between">
                    <h5 class="my-3 main-title">Liste des tous les tickets :</h5>
                        ...
                        <tbody>
                          @foreach ($tickets->sortBy('num_tic') as $ticket)
                                          <tr>
                                              ...
                                              <td>{{$ticket->delai}}</td>
                                              <td>
                                                  <button type="button" class="btn btn-outline-primary edit-btn" data-toggle="modal" data-target="#myModal-{{ $ticket->id }}" data-id="{{ $ticket->id }}">Voir</button>
                                              </td>
                                          </tr>
                          @endforeach
                          @foreach ($pauses->sortBy('num_tic') as $ticket)
                                          <tr>
                                              ...
                                              <td>{{$ticket->delai}}</td>
                                              <td>
                                                <button type="button" class="btn btn-outline-primary view-btn" data-toggle="modal" data-target="#modalmlam-{{ $ticket->id }}">Voir</button>
                                               </td>
                                          </tr>
                                ...
                                <form action="#" class="was-validated" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <b><label for="edit-lp-{{ $ticket->id }}">-Pompe Funèbre: <a href="{{ $ticket->lien_pompe }}">{{ $ticket->nom_pompe }}</a></label></b><br>
                                            <b><label for="edit-stat-{{ $ticket->id }}">-Statut : {{ $ticket->statut }}</label></b><br>
                                            <b><label for="edit-obs-{{ $ticket->id }}">-Observation : {{ $ticket->observation }}</label></b><br>
                                            <b><label for="edit-cr-{{ $ticket->id }}">-Date-heure debut : {{ $ticket->created_at }}</label></b><br>
                                            <b><label for="edit-fin-{{ $ticket->id }}">-heure fin : {{ $ticket->dateHeure_fin }}</label></b><br>
